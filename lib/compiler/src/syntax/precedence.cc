...
constexpr auto ALL_BINDINGS{stdx::fixed::enum_map<token_type_t, stdx::option<binding>>::from(
    ...
    map_pair{token_type_t::SHL_PIPE, bind_precedence::MUL_DIV},
    ...
    map_pair{token_type_t::SHL_PIPE_ASSIGN, assignment_binding},
